...
public class Test {
	public static void main(String[] args) {
		...
		Employee e1 = new Employee("Steve", 100000 , hireDate1 ,"KZ Health Insurance", "KZ23241") ;
		Employee e2 = new Employee("Smith" , 200000 , hireDate2 , "KZ Sport & Health Insurance",  "KZ101010"); 
		
		Employee e3 = new Employee("Many", 200000 , hireDate3 ,"KZ Healthy Insurance", "KZ23241") ;
		Employee e4 = new Employee("Steve", 100000 , hireDate1 ,"KZ Health Insurance", "KZ23241") ; 
		
		Manager m1 = new Manager("Johnson" , 1020000 , hireDate2 , "KZ WhyNotHealth insurance" , "KZ3292482" , 10000);
		Manager m2 = new Manager("Jordan" , 2000000 , hireDate3 , "KZ HealthyLife Insurance" , "KZ329484" , 12000) ;
		m1.addToTeam(e1); 
		m1.addToTeam(e2);
		m2.addToTeam(e3);
		m2.addToTeam(e4);
